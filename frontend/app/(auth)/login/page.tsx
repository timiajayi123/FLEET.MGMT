...
export default function LoginPage(){
 ...
 return <div className="auth-card"><div className="mobile-auth-brand"><span className="brand-mark">FM</span><strong>NMDPRA Fleet</strong></div><header><span>Secure access</span><h1>Welcome back</h1><p>Sign in with your official NMDPRA account.</p></header><form onSubmit={submit}><label><span>Email address</span><div className="input-with-icon"><Mail size={18}/><input name="email" type="email" placeholder="name@nmdpra.gov.ng" required/></div></label><label><span>Password</span><div className="input-with-icon"><LockKeyhole size={18}/><input name="password" type="password" placeholder="Enter your password" required minLength={8}/></div></label><div className="auth-options"><span/>
