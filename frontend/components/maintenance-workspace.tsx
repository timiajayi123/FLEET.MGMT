...
type MaintenanceRequest = { id: string; issueType: string; issueDescription: string; issueOccurredAt: string; status: string; serviceability?: string | null; adminRemark?: string | null; reviewedAt?: string | null; vehicle: Vehicle; reportedBy: { staffName: string; employeeId: string }; reviewedBy?: { staffName: string } | null; createdAt: string };
