...
function response(title: string, text: string, table: { label: string; value: string | number }[], action?: { label: string; href: string }) { return { title, text, table, action, source: 'controlled fleet analytics' }; }
