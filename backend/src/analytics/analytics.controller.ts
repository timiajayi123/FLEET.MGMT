...
function filters(query: Record<string, string>) { return { from: parseDate(query.from), to: parseDate(query.to, true), departmentId: query.departmentId || undefined, vehicleId: query.vehicleId || undefined, driverId: query.driverId || undefined, status: query.status || undefined, search: query.search || undefined, department: query.department || undefined, purpose: query.purpose || undefined, destination: query.destination || undefined, issueType: query.issueType || undefined, reportedById: query.reportedById || undefined, reviewedById: query.reviewedById || undefined }; }
